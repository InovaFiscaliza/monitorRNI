classdef winMonitoringPlan_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function startupFcn(app, mainapp)
            ...
            app.Data_PA_RNI = mainapp.Data_PA_RNI;
            app.Path_Data_PA_RNI_Out = mainapp.Path_Data_PA_RNI_Out;
    ...
    methods (Access = private)
        ...
        function createComponents(app, Container)
            ...
            app.menu_Button3Icon.ImageSource = 'Channel_18.png';
            ...
            app.menu_Button4Icon.ImageSource = 'Pin_18.png';
            ...
            app.toolGrid.ColumnWidth = {22, 22, 22, 5, 22, 22, 22, 22, '1x', 22};

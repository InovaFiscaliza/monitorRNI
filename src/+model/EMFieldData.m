            ...
            for ii = 1:numel(fileNameList)
                ...
                try
                    ...
                    dataTable = timetable( ...
                        ...
                        DIRECTION_MAPPING({rawData.LatOrientation}')  .* (floor(latValues/100) + 100*(latValues/100 - floor(latValues/100))/60), ...
                        DIRECTION_MAPPING({rawData.LongOrientation}') .* (floor(lngValues/100) + 100*(lngValues/100 - floor(lngValues/100))/60), ...
                        str2double({rawData.FieldValue})', ...

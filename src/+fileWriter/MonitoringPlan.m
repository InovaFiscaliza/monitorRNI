function [status, msgError] = MonitoringPlan(fileName, stationTable, measTable, ReferenceFielValue, RawMeasuresExportFlag)
    ...
    try
        ...
        stationTable = renamevars(stationTable, ...
            {'numberOfMeasures', 'numberOfRiskMeasures',         'minDistanceForMeasure', 'minFieldValue', 'meanFieldValue', 'maxFieldValue', 'maxFieldTimestamp',      'maxFieldLatitude', 'maxFieldLongitude'}, ...
            {'Qtd. Medidas',     'Qtd. Medidas Acima do Limite', 'Distância Mínima (km)', 'Emin (V/m)',    'Emean (V/m)',    'Emax (V/m)',    'Emax - Data da Medição', 'Emax - Latitude',  'Emax - Longitude'} ...
        );

classdef (Abstract) Controller
    ...
    methods (Static)
        ...
        %-----------------------------------------------------------------%
        function Run(app, projectData, measData, orientation, stationTable, pointsTable, issueId, modelNameIndex, reportVersion)
            arguments
                app
                projectData
                measData
            ...
            reportInfo = struct('App',      app, ...
                                ...
                                'Function', struct('table_Stations',        stationTable, ...
                                                   ...
                                                   'table_PointsFilteredByLocation', 'reportLibConnection.Table.PointsFilteredByLocation(reportInfo, analyzedData)', ...
                                                   'table_StationsFilteredByLocation', 'reportLibConnection.Table.StationsFilteredByLocation(reportInfo, analyzedData)', ...
                                                   'table_StationsFilteredByLocation_On', 'reportLibConnection.Table.StationsFilteredByLocation(reportInfo, analyzedData, "on")', ...
                                                   'table_StationsFilteredByLocation_Off', 'reportLibConnection.Table.StationsFilteredByLocation(reportInfo, analyzedData, "off")', ...
                                                   ...
